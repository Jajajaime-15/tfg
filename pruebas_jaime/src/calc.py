...
@ft.control # tambien serviria poner @dataclass
class CalcButton(ft.Button): # clase que permite que las demas hereden y asi facilita su reproducibilidad
    ...
    def init(self):
        ...
        self.content = ft.Column(
            controls= [
                ...
                ft.Row(
                    controls=[
                        ExtraActionButton(content="AC", on_click=self.button_clicked), # hay que aclarar lo de content para que no salte error
