...
def RegisterView(page, myPyrebase):
    ...
    banner = ft.Image(src='banner.png', width=250, border_radius=5, fit="cover")
    welcome_text = ft.Text("User Registration", size=26, bottom=10, right=10, color=ft.Colors.WHITE_70)
