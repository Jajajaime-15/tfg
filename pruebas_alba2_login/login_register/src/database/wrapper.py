# archivo en el que se inicia Firebase y se crean las funciones para registrar un usuario y para iniciar sesion
...
class Wrapper:
    ...
    def registro (self, nombre, telefono, email, psw):
        try:
    ...
    async def inicio_sesion (self,email,psw):
        try:
